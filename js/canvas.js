...
function cabeza(){  
    pincel.fillStyle = "black";       
    pincel.arc(450,220,30,0,2*Math.PI);
    pincel.stroke();
}
function cuerpo(){    
    pincel.beginPath();
...
function escribirLetra(letra){
    ...
    pincel.beginPath()
    pincel.fillStyle="#1C658C"; 
    pincel.font="bold 20px Helvetica"; 
    pincel.fillText(texto,700,230); 
    texto=letra;
    pincel.beginPath()
    pincel.fillStyle="#398AB9"; 
    pincel.font="bold 20px Helvetica"; 
...
function escribirPalabraSecreta(letra){
    ...
    pincel.beginPath()
    pincel.fillStyle="#1C658C"; 
    pincel.font="bold 30px Helvetica";      
...
function mensajeFinal(mensaje,color){
    ...
    pincel.font="bold 40px Helvetica";      
